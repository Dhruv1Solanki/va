class Game{
    ...
    {       
            ...
            var obstacle2Positions = [
                { x: width / 2 - 100, y: height - 1000, image: obstacle2Image },
                { x: width / 2 + 150, y: height - 1000, image: obstacle2Image },
                { x: width / 2 - 120, y: height - 3000, image: obstacle2Image },
               
                { x: width / 2 - 160, y: height - 1000, image: obstacle2Image },
                { x: width / 2 - 130, y: height - 3400, image: obstacle2Image },
              ];
              var obstacle1Positions = [
                { x: width / 2 - 150, y: height - 1000, image: obstacle1Image },
                { x: width / 2 + 250, y: height - 1000, image: obstacle1Image },
                { x: width / 2 - 180, y: height - 1000, image: obstacle1Image },
